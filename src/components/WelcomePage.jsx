    ...
    <div className="flex flex-col w-full md:flex-row p-[100px] items-center justify-center">
      <div className="max-w-2xl md:w-1/2 mb-8 md:mb-0">
        ...
        <div className="flex items-center space-x-4">
          <button className="bg-[#cf9fff] hover:bg-[#d6adff] text-white px-6 py-3 rounded-md transition duration-300">
      ...
      <div className="p-10 w-[70%]">
        <img src={Image} alt="Data career image" className="w-full h-auto" />
      </div>
    </div>
  );
}
